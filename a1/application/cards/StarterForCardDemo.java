...
import static application.cards.Card.*;
import static application.cards.Card.Constant.*;
 ...
 */
/**
 * Die Klasse {@link StarterForCardDemo} soll beispielhaft den Umgang
 ...
 */
public class StarterForCardDemo {
    //
    //--VERSION:-------------------------------#---vvvvvvvvv---vvvv-vv-vv--vv
    //  ========                               #___~version~___YYYY_MM_DD__dd_
    final static private long encodedVersion = 2___00001_008___2023_04_25__01L;
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
    ...
    public static void main( final String... unused ){
         ...
         * vermutlich die "Scope-Regeln" noch nicht bekannt, daher kommen hier
         * die Deklarationen am Anfang.
        ...
        // o) "Nichts" bzw. alles Nötige wurde in der Vorlesung besprochen,bevor das cards-Package das erste Mal angesprochen wird.
